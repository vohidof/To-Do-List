...
import kotlinx.android.synthetic.main.activity_about_list_to_do.*
import kotlinx.android.synthetic.main.item_spinner.*

class AboutListToDo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_about_list_to_do)
        ...
        println(name)
        val planArray = MySharedPreference.obektString
        var plan1 = TodoPlan()
        var index = -1
        ...
        btn_ok.setOnClickListener {
            ...
            MySharedPreference.obektString = planArray
